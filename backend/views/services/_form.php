...
<div class="services-form">
    ...
    <div class="row">
        <div class="col-md-8">    <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tabLang_11">
                        ...
                        <?= $form->field($model, 'description_ru')->textarea(['rows' => 16]) ?>
                    ...
                    <div class="tab-pane " id="tabLang_21">
                        ...
                        <?= $form->field($model, 'description_uz')->textarea(['rows' => 16]) ?>
                    </div>

                    <div class="tab-pane " id="tabLang_31">
                        <?= $form->field($model, 'title_en')->textarea(['rows' => 6]) ?>

                        <?= $form->field($model, 'description_en')->textarea(['rows' => 16]) ?>
                    </div>
                </div>
            </div></div>
        <div class="col-md-4">
